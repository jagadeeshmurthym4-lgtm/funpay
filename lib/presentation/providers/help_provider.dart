...
class HelpProvider extends ChangeNotifier {
  ...
  List<Map<String, dynamic>> _defaultFAQs() {
    return [
      ...
      {'question': 'How do I withdraw my earnings?', 'answer': 'Go to the Withdraw section from the home screen. Select your preferred method (UPI, Paytm, or Bank Transfer). Minimum withdrawal is \u20B985 and maximum is \u20B9500 per transaction.', 'category': 'withdrawals', 'order': 2},
