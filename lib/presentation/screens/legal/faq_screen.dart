    ...
    return Scaffold(
      ...
      body: Container(
        ...
        children: [
          ...
          _buildItem(theme, 1, 'How do I redeem my balance?',
              'Go to the Redeem section from the home screen. Choose an in-platform perk such as Premium access, bonus spins, exclusive themes, or boosters. Minimum redemption is ₹10.'),
          ...
          _buildItem(theme, 4, 'Is there a limit on daily earnings?',
              'Yes, there are daily limits to ensure fair usage. Check the Rewards section for current limits. Your balance has no cash value and can only be spent on in-platform perks.'),
