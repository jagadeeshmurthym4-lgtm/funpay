      ...
      body: Container(
        ...
        children: [
          ...
          _buildItem(theme, 1, 'How do I withdraw my earnings?',
              'Go to the Withdraw section from the home screen. Select your preferred method (UPI, Paytm, or Bank Transfer). Minimum withdrawal is \u20B985 and maximum is \u20B9500 per transaction.'),
