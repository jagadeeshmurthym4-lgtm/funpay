    ...
    return Scaffold(
      ...
      body: Container(
        ...
        children: [
          ...
          _buildItem(theme, 1, 'How do I redeem my points?',
              'Go to the Redeem Points section from the home screen. Choose an in-platform perk such as Premium access, bonus spins, exclusive themes, or boosters. Minimum redemption is 10 pts.'),
          _buildItem(theme, 2, 'How long do redemptions take?',
              'Redemption requests are reviewed and typically processed within 24-48 hours. Once approved, your chosen perk is granted to your account.'),
          ...
          _buildItem(theme, 4, 'Is there a limit on daily earnings?',
              'Yes, there are daily limits to ensure fair usage. Check the Rewards section for current limits. Points have no cash value and can only be spent on in-platform perks.'),
